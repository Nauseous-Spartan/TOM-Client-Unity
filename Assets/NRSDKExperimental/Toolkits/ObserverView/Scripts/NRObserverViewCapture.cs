...
namespace NRKernal.Experimental.StreammingCast
{
    ...
    public class NRObserverViewCapture : IDisposable
    {
        ...
        public void StartObserverViewModeAsync(NRKernal.Record.CameraParameters setupParams, AudioState audioState, OnObserverViewModeStartedCallback onVideoModeStartedCallback, bool autoAdaptBlendMode = false)
        {
