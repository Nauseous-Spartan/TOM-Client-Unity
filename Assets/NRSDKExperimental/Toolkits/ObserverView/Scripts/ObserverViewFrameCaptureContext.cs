...
namespace NRKernal.Experimental.StreammingCast
{
    ...
    public class ObserverViewFrameCaptureContext
    {
        ...
        private NRKernal.Record.CameraParameters m_CameraParameters;
        ...
        public NRKernal.Record.CameraParameters RequestCameraParam()
        {
        ...
        public void StartCaptureMode(NRKernal.Record.CameraParameters param)
        {
